...
import com.alignsolution.customermobileapplication.AdapterMenu.ClaimStep2Activity_Adapter;
...
public class ClaimStep2Activity extends AppCompatActivity  implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ClaimStep2Activity_Adapter adapter1=new ClaimStep2Activity_Adapter(ClaimStep2Activity.this,
                itemname, arrImg);
        ...
        Button cmd = (Button) findViewById(R.id.button18);
