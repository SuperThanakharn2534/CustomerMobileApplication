...
import com.alignsolution.customermobileapplication.AdapterMenu.ProductPromotionListActivity_Adapter;
...
public class ProductPromotionListActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_promotion_list);
        SetMenu();

        ProductPromotionListActivity_Adapter adapter1=new ProductPromotionListActivity_Adapter(ProductPromotionListActivity.this,
                itemname, arrImg);
        ...
        Button cmd1 = (Button) findViewById(R.id.button10);
        cmd1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Intent it2 = new Intent(getBaseContext(),Nav_Activity.class);
                Intent it2 = new Intent(getBaseContext(),ProductPromotionDetailActivity.class);
                startActivity(it2);
            }
        });
