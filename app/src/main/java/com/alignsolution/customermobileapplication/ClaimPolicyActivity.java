...
import com.alignsolution.customermobileapplication.AdapterMenu.ClaimPolicyActivity_Adapter;
...
public class ClaimPolicyActivity extends AppCompatActivity  implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ClaimPolicyActivity_Adapter adapter1=new ClaimPolicyActivity_Adapter(ClaimPolicyActivity.this,
                itemname, arrImg);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ClaimPolicyActivity.this, ClaimStep1Activity.class);
