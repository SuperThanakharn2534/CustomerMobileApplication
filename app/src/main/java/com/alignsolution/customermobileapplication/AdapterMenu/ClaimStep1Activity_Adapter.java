...
import com.alignsolution.customermobileapplication.ClaimStep1Activity;
...
public class ClaimStep1Activity_Adapter extends ArrayAdapter<String> {
    private final Activity context;
    private final String[] web;
    private final Integer[] imageId;


    public ClaimStep1Activity_Adapter(ClaimStep1Activity context,
