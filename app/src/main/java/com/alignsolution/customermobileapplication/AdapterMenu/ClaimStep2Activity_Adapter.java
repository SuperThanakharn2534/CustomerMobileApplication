...
import com.alignsolution.customermobileapplication.ClaimStep2Activity;
...
public class ClaimStep2Activity_Adapter extends ArrayAdapter<String> {
    private final Activity context;
    private final String[] web;
    private final Integer[] imageId;


    public ClaimStep2Activity_Adapter(ClaimStep2Activity context,
