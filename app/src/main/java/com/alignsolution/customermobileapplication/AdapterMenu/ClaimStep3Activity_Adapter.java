...
import com.alignsolution.customermobileapplication.ClaimStep3Activity;
...
public class ClaimStep3Activity_Adapter extends ArrayAdapter<String> {
    ...
    public ClaimStep3Activity_Adapter(ClaimStep3Activity context,
