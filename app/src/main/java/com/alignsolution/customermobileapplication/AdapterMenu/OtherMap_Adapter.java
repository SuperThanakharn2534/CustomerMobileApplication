...
import com.alignsolution.customermobileapplication.OtherMap;
...
public class OtherMap_Adapter extends ArrayAdapter<String> {
    ...
    public OtherMap_Adapter(OtherMap context,
