...
import com.alignsolution.customermobileapplication.ProductPromotionDetailActivity;
...
public class ProductPomotionDetail_Adapter extends ArrayAdapter<String> {
    ...
    public ProductPomotionDetail_Adapter(ProductPromotionDetailActivity context,
