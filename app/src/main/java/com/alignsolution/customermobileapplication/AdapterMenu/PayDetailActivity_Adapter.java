...
import com.alignsolution.customermobileapplication.PayDetailActivity;
...
public class PayDetailActivity_Adapter extends ArrayAdapter<String> {
    ...
    public PayDetailActivity_Adapter(PayDetailActivity context,
