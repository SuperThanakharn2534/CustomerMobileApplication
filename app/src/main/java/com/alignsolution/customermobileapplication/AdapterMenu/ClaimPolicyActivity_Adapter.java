...
import com.alignsolution.customermobileapplication.ClaimPolicyActivity;
...
public class ClaimPolicyActivity_Adapter extends ArrayAdapter<String> {
    ...
    public ClaimPolicyActivity_Adapter(ClaimPolicyActivity context,
