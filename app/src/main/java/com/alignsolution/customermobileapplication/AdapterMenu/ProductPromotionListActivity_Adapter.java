...
public class ProductPromotionListActivity_Adapter extends ArrayAdapter<String> {
       private final Activity context;
        private final String[] web;
        private final Integer[] imageId;


        public ProductPromotionListActivity_Adapter(ProductPromotionListActivity context,
