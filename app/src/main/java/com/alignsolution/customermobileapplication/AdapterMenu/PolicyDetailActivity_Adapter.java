...
import com.alignsolution.customermobileapplication.PolicyDetailActivity;
...
public class PolicyDetailActivity_Adapter extends ArrayAdapter<String> {
    ...
    public PolicyDetailActivity_Adapter(PolicyDetailActivity context,
