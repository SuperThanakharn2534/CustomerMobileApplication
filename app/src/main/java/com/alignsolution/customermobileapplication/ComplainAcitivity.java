...
import com.alignsolution.customermobileapplication.AdapterMenu.ComplainActivity_Adapter;
...
public class ComplainAcitivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ComplainActivity_Adapter adapter1=new ComplainActivity_Adapter(ComplainAcitivity.this,
                itemname, arrImg);
